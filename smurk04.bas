 ...
 7 NA$="SMURK"
 8  REM PORT BY Zombie Ryushu & Retro Rick 
10 D$=CHR$(4)
 15  DIM LV%(100,8),LD$(100,1),ID$(50),IL%(50),SC%(50),IW(50),L%(100),WD$(100),W%(100,1),FW%(2),FB%(50),RE%(50)
 20  GOSUB 18000: GOSUB 19000
 50 SP=255: SPEED=SP
 60  CLS: PRINT 
 100  REM  START
 108 XX=1
 110  IF SC%>999 THEN PRINT"YOU WIN!": PRINT "END AFTER"T"TURNS.": PRINT "FINAL SCORE: 1000 OUT OF 1000.": SPEED=255: END
 ...
 540 WD$=WD$+MID$(I$,A,1)
 550 A=A+1: IF A+1<LEN(I$) THEN 530
 600  REM  FOUND WORD
 ...
 1000  REM  PRINT DESC
 1005  PRINT 
 1006  IF L=11 OR L=38 OR L<5 THEN 1010
 1007  IF LO%=0 THEN 1009
 1008  I=1: GOSUB 11000: IF R<>0 THEN 1010
 1009  PRINT "IT IS TOO DARK TO SEE.": RETURN 
 1010  PRINT LD$(L,L%(L))
 1014  PRINT 
 1015 L%(L)=1
 ...
 1100 IF L<>11 THEN 1120
 1101  IF TR%=0 THEN PRINT"THERE IS A FEROCIOUS TIGER HERE!": RETURN
 1110  PRINT"A CONTENTED-LOOKING TIGER DOZES HERE.": RETURN
 1120  IF L<>38 THEN 1490
 1125  IF SM%=0 THEN PRINT"THE SMURK IS HERE!": RETURN
 1130  PRINT "THE DEAD BODY OF THE SMURK LIES HERE."
 1490  RETURN
 2000  REM  MOVE
 ...
 2045 A=0
 2050  IF X=38 THEN I=7: GOSUB 11000: IF R<2 THEN 2200
 2055  A=100:  PRINT "THE SMURK SEES THE POISON AND SAYS:     YOU ARE TRYING TO POISON ME, HUH?  I    WILL KILL YOU FOR THAT!  HE POINTS AT   YOU AND YOU COLLAPSE INTO ASHES."
 2060  PRINT "STOP AFTER"T"TURNS.": PRINT "FINAL SCORE:"SC%" OUT OF 1000.": SPEED=255: END 
 ...
 3030  IF I<1 OR I>NI THEN 19900
 3040  IF IL%(I)=-2 AND RE%(I)=2 THEN I=2
 3045  GOSUB 11000: IF R=0 THEN 19900
 ...
 3340 B=B+1: IF B+1< NI THEN 3330
 ...
 3530  IF L=11 AND FW%(1)=19 AND TR%=0 THEN PRINT "THE TIGER IS IN THE WAY!": RT=1 : RETURN 
 ...
 4040 IL%(I)=L
 4050  PRINT "OK."
 4055  IF I=20 AND L=11 THEN PRINT "THE TIGER GOBBLES IT UP AND CURLS IN A  CORNER SLEEPING CONTENTFULLY.": TR%=1: IL%(I)=-1: SC%=SC%+100
 ...
 6020  REM  PRINT D$"OPEN GAME."NA$",L500"
 6021  I$=NA$+CHR$(49+A)+".DAT": OPEN I$ FOR OUTPUT AS #1
 6030  REM  PRINT D$"WRITE GAME."NA$",R"A
 6031  PRINT "WRITING TO ";I$;" ..."
 6040  PRINT #1,L: FOR B=1 TO NI: PRINT #1,IL%(B): NEXT
 6050  PRINT #1,SC%: PRINT #1,SM%: PRINT #1,T: PRINT #1,TR%
 6060  FOR B=1 TO NI: PRINT #1,SC%(B): NEXT
 6070  PRINT #1,LO%: PRINT #1,MX%
 6080  PRINT #1,PN%
 6090  CLOSE #1
 ...
 6531  I$=NA$+CHR$(49+A)+".DAT": OPEN I$ FOR INPUT AS #1
 6540  PRINT "READING "I$" ..."
 6550  INPUT #1,L: FOR B=1 TO NI: INPUT #1,IL%(B): NEXT
 6560  INPUT #1,SC%: INPUT #1,SM%: INPUT #1,T: INPUT #1,TR%
 6565  FOR B=1 TO NI: INPUT #1,SC%(B): NEXT
 6570  INPUT #1,LO%: INPUT #1,MX%
 6580  INPUT #1,PN%
 6599  CLOSE #1
 6600  RETURN 
 6900  REM  ONERR
 ...
 8000  REM  READ
 8002  IF FW%(1)<1 OR FW%(1)>NI THEN 19900
 8005 I=FW%(1): GOSUB 11000: IF R=0 THEN 19900
 8010  IF FW%(1)<>15 THEN PRINT "NOTHING SPECIAL.": RETURN 
 8020  I=16: GOSUB 11000: IF R=0 THEN PRINT "IT IS IN SANSKRIT.": RETURN 
 8030  PRINT: PRINT "IT SAYS:": PRINT "   A SMURK IS NEARLY INVULNERABLE.  THE ONLY KNOWN WAY TO KILL ONE IS TO POUR   POISON IN ITS WATER SUPPLY.  A SUBSTANCE";
 8040  PRINT "POISONOUS TO A SMURK CAN BE PRODUCED    USING THE FOLLOWING INGREDIENTS:": PRINT "  TIGER LILIES": PRINT "  OIL": PRINT "  VINEGAR": PRINT "  BROCCOLI": PRINT "  MAGIC POWDER #"PN%
 8050  PRINT "PLACE ALL THESE TOGETHER IN A BOWL AND  MIX.": PRINT : RETURN 
 9000  REM  POUR
 9010  IF FW%(1)<1 OR FW%(1)>NI THEN 19900
 9020 I=FW%(1): GOSUB 11000: IF R=0 THEN 19900
 9030 Z=0: X=L
 ...
 9210  IF A=20 AND L=11 THEN PRINT"THE TIGER GOBBLES UP THE STEAK AND CURLSIN A CORNER SLEEPING CONTENTFULLY.": TR%=1: IL%(A) =-1: SC%=SC%+100
 ...
 9320  NEXT: IF A>1 THEN PRINT "YOU CAN'T FIT ALL THAT IN THE BOTTLE.": RT=1 : RETURN
 9330  IF NF=1 THEN  PRINT "IT WON'T FIT!": RT=1 : RETURN 
 9340 X=-2: RETURN 
 9500  REM  PUT
 9510  IF FW%(1)<0 OR FW%(1)>NI OR FW%(2)<0 OR FW%(2)>NI THEN PRINT "PUT WHAT IN WHAT?": RETURN 
 9530  IF (FW%(1)=4 AND L=17) OR (FW%(1)=21 AND (L=38 OR L=40)) THEN FW%(1)=FW%(2): GOTO 13500
 9540 I=FW%(2): GOSUB 11000: IF R=0 THEN 19900
 9550  IF FW%(1)<1 OR FW%(1)>NI THEN 19900
 ...
 9590  NEXT: IF F=1 THEN RETURN 
 9600  IF FW%(1)=2 THEN PRINT "YOU CAN'T PUT IT IN ITSELF!": RETURN 
 9610 I=FW%(1): X=IL%(I): GOSUB 11000: IF R=0 THEN 19900
 ...
 13550  NEXT: IF A>0 THEN PRINT "THE BOTTLE IS FULL.": RETURN 
 13600  REM 
 13605 A=0
 ...
 18060  PRINT 
 18065  REM RH HTAB 3
 18070  INPUT "   INSTRUCTIONS? (Y/N) ";I$: IF  LEFT$ (I$,1) = "N" THEN  CLS : PRINT : RETURN 
 ...
 18585  PRINT : INPUT "*** HIT RETURN TO CONTINUE ***";I$: CLS 
 ...
 18635  PRINT : INPUT "*** HIT RETURN TO CONTINUE ***";I$: CLS
 ...
 18735  PRINT : INPUT "*** HIT RETURN TO CONTINUE ***";I$: CLS 
 ...
 18756  PRINT : INPUT "*** HIT RETURN TO CONTINUE ***";I$: CLS
 ...
 18790  PRINT : INPUT "*** HIT RETURN TO BEGIN ***";I$: CLS : PRINT : RETURN 
 19000  REM  INITIALIZE 
 19002  PRINT "PLEASE WAIT. INITIALIZING DATA."
 19005  FOR A=1 TO 8: READ DN$(A): NEXT
 19020 A=1
 19025  FOR B=0 TO 1: READ LD$(A,B): NEXT: IF LD$(A,0)<>"" THEN A=A+1: GOTO 19025
 19027 NL=A-1
 19030  FOR A=1 TO NL: FOR B=1 TO 8: READ LV%(A,B): NEXT B,A
 19050 A=1
 19060  READ ID$(A),IL%(A),IW(A),SC%(A): IF IL%(A)<>-999 THEN A=A+1: GOTO 19060
 19065 NI=A-1
 19067  FOR A=1 TO NI: READ FB%(A),RE%(A): NEXT
 19070 A=1
 19075  READ WD$(A),W%(A,0),W%(A,1): IF WD$(A)<>"" THEN A=A+1: GOTO 19075
 19080 NW=A-1
 19085 L=1: T=1
 19090  CLS: PRINT: INPUT "LOAD GAME FROM DISK? (Y/N) ";I$
 19092 REM RH DUMMY =  RND ( -  PEEK (79) * 256 -  PEEK (78)): REM RANDOM SEED
 19094 PN%=10+INT(RND(1)*90)
 19100  IF LEFT$(I$,1)="Y"THEN GOSUB 6500
 19120  RETURN 
 19900  PRINT "NO SUCH THING HERE.": RETURN
 20000  REM  DATA
